	...
	namespace Controls
	{
		class GWEN_EXPORT Canvas : public Base
		{
			public:
				...
				//signal canvas to quit, return true if already waiting to quit 
				virtual bool InputQuit(void) { if (m_bQuit)return true;  m_bQuit = true; return false; }
				//check if canvas has an quit signal
				virtual bool WantsQuit(void) { return m_bQuit; };
				...
				virtual void ReleaseChildren(void);
				...
				//virtual bool InputQuit(void) { return true; };
