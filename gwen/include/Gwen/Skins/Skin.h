	...
	namespace Skin
	{
		...
		class GWEN_EXPORT Base
		{
			public:
				...
				Base(Gwen::Renderer::BaseRender* renderer = NULL);

				virtual ~Base(void);
				virtual void ReleaseFont(Gwen::Font::FontBase* fnt);
				virtual void InitializeFont(Gwen::Font::FontBase* fnt);
				...
				virtual void SetRender( Gwen::Renderer::BaseRender* renderer )
				{
					m_Render = renderer;
				}
				virtual Gwen::Renderer::BaseRender* GetRender()
				{
					return m_Render;
				}
			...
			public:
				...
				virtual Gwen::Font::FontBase* GetDefaultFont()
				{
			...
			protected:
				...
				Gwen::Font::FontBase*		m_DefaultFont;
				Gwen::Renderer::BaseRender* m_Render;
